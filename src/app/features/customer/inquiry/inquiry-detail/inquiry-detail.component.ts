...
export class InquiryDetailComponent implements OnInit, OnDestroy {
  ...
  breadcrumbItems: BreadcrumbItem[] = [
    { label: 'My inquiries', route: '/customer/inquiries/active' },
    { label: 'Active', route: '/customer/inquiries/active' }
  ];
  ...
  private loadOrder(id: string): void {
    ...
    if (orderData) {
      ...
      const label = orderData.type === 'order' ? `Order #${orderData.id}` : `Inquiry #${orderData.id}`;
